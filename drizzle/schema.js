...
export const studentProfiles = mysqlTable("student_profiles", {
    ...
    targetExams: json("targetExams").$type(), // Array of exam names
    targetYear: int("targetYear"),
    targetMonth: int("targetMonth"),
    preferredLanguages: json("preferredLanguages").$type(),
    preferredSubjects: json("preferredSubjects").$type(),
...
export const topics = mysqlTable("topics", {
    ...
    name: varchar("name", { length: 255 }).notNull(),
    description: text("description"),
    prerequisites: json("prerequisites").$type(), // Array of topic IDs
    learningOutcomes: json("learningOutcomes").$type(),
...
export const doubts = mysqlTable("doubts", {
    ...
    alternativeMethods: json("alternativeMethods").$type(),
    commonMistakes: json("commonMistakes").$type(),
...
export const subscriptionPlans = mysqlTable("subscription_plans", {
    ...
    examAccess: json("examAccess").$type(),
    active: boolean("active").default(true),
    createdAt: timestamp("createdAt").defaultNow().notNull(),
});
/**
